...
const nav = [
  ...
  { n: '06', label: 'Sessions',  href: '/sessions',  icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { n: '07', label: 'Activity',  href: '/events',    icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { n: '08', label: 'Channels',  href: '/channels',  icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
]
