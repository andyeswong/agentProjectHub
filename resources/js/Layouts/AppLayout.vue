...
const nav = [
  ...
  { n: '04', label: 'Assets',    href: '/assets',    icon: 'M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm0 12l4.5-4.5a1 1 0 011.4 0l3.6 3.6m0 0l2.1-2.1a1 1 0 011.4 0L20 17M14 9a1 1 0 11-2 0 1 1 0 012 0z' },
  { n: '05', label: 'Brands',    href: '/brands',    icon: 'M7 7h.01M3 5a2 2 0 012-2h5.586a1 1 0 01.707.293l7.414 7.414a2 2 0 010 2.828l-5.586 5.586a2 2 0 01-2.828 0L3.293 11.707A1 1 0 013 11V5z' },
  { n: '06', label: 'Agents',    href: '/agents',    icon: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v10m0 0h10M9 13H5m4 0a2 2 0 010 4H5a2 2 0 010-4' },
  { n: '07', label: 'Pilots',    href: '/pilots',    icon: 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4zm6 0a4 4 0 00-3-3.87M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
  { n: '08', label: 'Identity',  href: '/personalities', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { n: '09', label: 'Sessions',  href: '/sessions',  icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { n: '10', label: 'Activity',  href: '/events',    icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { n: '11', label: 'Channels',  href: '/channels',  icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
]
