...
const nav = [
  ...
  { n: '05', label: 'Pilots',    href: '/pilots',    icon: 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4zm6 0a4 4 0 00-3-3.87M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
  { n: '06', label: 'Identity',  href: '/personalities', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { n: '07', label: 'Sessions',  href: '/sessions',  icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { n: '08', label: 'Activity',  href: '/events',    icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { n: '09', label: 'Channels',  href: '/channels',  icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
]
